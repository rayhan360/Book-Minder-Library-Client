...
import dark from "../assets/brightness.png"
...
const NavBar = ({ isDarkMode, toggleMode }) => {
  ...
  return (
    <div
      className={`lg:fixed top-0 left-0 right-0 bg-[#1a2d62] lg:bg-${navbarBackground} transition-all duration-300 z-50  lg:text-white`}
    >
      <div className="flex justify-between items-center max-w-7xl mx-auto">
        ...
        <div className="">
          ...
          <div>
            <nav
              className={`absolute bg-[#1a2d62] z-50 lg:bg-transparent lg:block lg:static px-5 ${
                  ...
                  {user ? (
                    <div className=" flex items-center gap-3">
                      <div className="dropdown dropdown-end">
                        ...
                        <ul
                          tabIndex={0}
                          className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-72 md:w-96"
                        >
                          <li>
                            <button className="text-black text-base">
                      ...
                      <div>
                        <button
                          onClick={logOut}
                          className="bg-[#f6425f] text-white px-5 py-2 rounded-md"
                        >
                          Sign Out
                        </button>
                      </div>
                    ...
                    <div className="mb-5 md:mb-0">
                      <Link to="/signIn">
                        <button
                          className="border text-white border-[#f6425f] px-5 py-2 rounded-md hover:bg-[#f6425f] hover:text-white"
                          type="button"
